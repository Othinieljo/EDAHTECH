...
<div class="relative bg-cover bg-center h-96" style="background-image: url('/main/images/height.jpg');">
    ...
    <div class="relative container mx-auto px-4 h-full flex items-center">
        <div class="text-center w-full">
            <h2 class="text-5xl font-extrabold text-white drop-shadow-lg">Prestations & Services</h2>
        </div>
    </div>
...
<div class="container mx-auto p-6 py-16 flex justify-center items-center">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-24">
      ...
      <div class="rounded-xl bg-white p-6 text-center shadow-xl" data-aos-delay="300">
        ...
        <h1 class="text-darken mb-3 pt-3 text-xl font-extrabold lg:h-14 lg:px-14">Etudes</h1>
      ...
      <div class="rounded-xl bg-white p-6 text-center shadow-xl" data-aos-delay="300">
        ...
        <h1 class="text-darken mb-3 pt-3 text-xl font-extrabold lg:h-14 lg:px-14">Conseil</h1>
        <a href="{{route('contact')}}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800">
          Contactez-nous
          <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
      ...
      <div class="rounded-xl bg-white p-6 text-center shadow-xl" data-aos-delay="300">
        ...
        <h1 class="text-darken mb-3 pt-3 text-xl font-extrabold lg:h-14 lg:px-14">Formation & Renforcement des capacités</h1>
        <a href="{{route('contact')}}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800">
          Contactez-nous
          <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
...
<div data-aos-delay="300" class="rounded-xl bg-white p-6 text-center shadow-xl">
  ...
  <h1 class="text-darken mb-3 pt-3 text-xl font-extrabold lg:h-14 lg:px-14">Ingénierie de projet</h1>
...
<div data-aos-delay="300" class="rounded-xl bg-white p-6 text-center shadow-xl">
  ...
  <h1 class="text-darken mb-3 pt-3 text-xl font-extrabold lg:h-14 lg:px-14">Gestion de projet – Suivi et Evaluation</h1>
  <a href="{{route('contact')}}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    Contactez-nous
    <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
...
<div data-aos-delay="300" class="rounded-xl bg-white p-6 text-center shadow-xl">
  ...
  <h1 class="text-darken mb-3 pt-3 text-xl font-extrabold lg:h-14 lg:px-14">Externalisation de services - outsourcing</h1>
  <a href="{{route('contact')}}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    Contactez-nous
    <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
...
<div data-aos-delay="300" class="rounded-xl bg-white p-6 text-center shadow-xl">
  ...
  <h1 class="text-darken mb-3 pt-3 text-xl font-extrabold lg:h-14 lg:px-14">Assistance technique AMOA et AMOE</h1>
  <a href="{{route('contact')}}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    Contactez-nous
    <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
...
<div data-aos-delay="300" class="rounded-xl bg-white p-6 text-center shadow-xl">
  ...
  <h1 class="text-darken mb-3 pt-3 text-xl font-extrabold lg:h-14 lg:px-14">Conduite du changement, Gestion – Transformation des conflits</h1>
  <a href="{{route('contact')}}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    Contactez-nous
    <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
...
<div data-aos-delay="300" class="rounded-xl bg-white p-6 text-center shadow-xl">
  ...
  <h1 class="text-darken mb-3 pt-3 text-xl font-extrabold lg:h-14 lg:px-14">Développement d’applications (web, mobile, ...)</h1>
  <a href="{{route('contact')}}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    Contactez-nous
    <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
