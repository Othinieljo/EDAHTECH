...
<div class="relative bg-cover bg-center h-96" style="background-image: url('/main/images/height.jpg');">
    ...
    <div class="relative container mx-auto px-4 h-full flex items-center">
        <div class="text-center w-full">
            <h2 class="text-5xl font-extrabold text-white drop-shadow-lg">{{__("main/contents/services.title")}}</h2>
        </div>
    </div>
            ...
            <ol class="flex overflow-hidden  border border-gray-200 text-primary bg-white px-4 ">
                <li class="flex items-center">
                    ...
                    >
                        ...
                        <span class="ms-1.5  font-bold text-lg">{{__("main/contents/services.title-1-1")}}</span>
                    </a>
                </li>
                ...
                <li class="relative flex items-center">
                    ...
                    >
                    {{__("main/contents/services.title-1-2")}}
                    </a>
                </li>
            </ol>
        </div>
